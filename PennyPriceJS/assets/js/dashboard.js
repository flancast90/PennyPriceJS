...
.header {
  ...
  padding-right: none !important !important;
...
<body style="width:500px; overflow-x:hidden;">

<!-- Header -->
<div class="header" style="width:100%;">
<div style="width:500px; position: absolute; left:0px; white-space:nowrap; overflow-x:scroll; top:10px;"><b>Deals </b><button id="tech">Tech</button>&nbsp<button id="fashion">Fashion</button>&nbsp<button id="homeg">Home & Garden</button>&nbsp<button id="sports">Sporting Goods</button>&nbsp<button id="automotive">Automotive</button>&nbsp<button id="other">Other</button>&nbsp</div>
...
<p><b>Show your appreciation for our services by giving this project<a class="github-button" href="https://github.com/flancast90/PennyPriceJS" data-color-scheme="no-preference: light; light: light; dark: light;" data-size="large" aria-label="Star flancast90/PennyPriceJS on GitHub"> A Star</a> on <a href="www.github.com">GitHub</a>!</b>
</p></center>
